...
function setCustomCanvas() {
    html2canvas(document.querySelector("#table"), {width: document.querySelector("#table").clientWidth, height: document.querySelector("#table").clientHeight, imageTimeout: 6000, useCORS: true}).then(canvas => { innerCustomCanvas = canvas; });
}

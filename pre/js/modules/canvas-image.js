...
function setChartCanvas() {
    html2canvas(document.querySelector("#chartBlock"), {width: 960, height: document.querySelector("#chartBlock").clientHeight, imageTimeout: 8000, useCORS: true}).then(canvas => { innerCanvas = canvas; });
}

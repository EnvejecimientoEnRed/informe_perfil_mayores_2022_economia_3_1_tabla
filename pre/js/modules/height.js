...
function setChartHeight(iframe) {
    if(iframe == 'fixed') {
        ...
        document.getElementsByClassName('container')[0].style.height = '686px';
        document.getElementsByClassName('main')[0].style.height = '658px';
        ...
        let height = 658; //Altura total del main
